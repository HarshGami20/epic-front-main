...
const FeaturedBlog = ({ data }: { data?: any }) => {
    return (
        <div className="row">
            <div className="col-lg-8 left-box">
                <FeaturedCategorySlider data={data} />
                <Link className="icon-button" href="/shop">
            ...
            <div className="col-lg-4 right-box">
                <div>
                    <h3 className="title wow fadeInUp" data-wow-delay="1.2s">{data?.title || "Featured Categories"}</h3>
                    <p className="text wow fadeInUp" data-wow-delay="1.4s">{data?.description || "Discover the most trending products in Pixio."}</p>
