                        ...
                        <div className="col-xl-3 col-md-4 col-sm-6"  >
                            <div className="widget widget_about me-2">
                                ...
                                <ul className="widget-address">
                                    <li>
                                        <p><span>Address</span> : 2, lakshmi Campus, Tulsi Chowk,Katargam, Surat, Gujarat - 395004</p>
                                    </li>
                                    <li>
                                        <p><span>E-mail</span> :  radeonenterprise@gmail.com</p>
                                    </li>
                                    <li>
                ...
                <div className="container">
                    <div className="row fb-inner">
                        <div className="col-lg-6 col-md-12 text-start">
                            <p className="copyright-text">© <span className="current-year">{year}</span> <a href="https://www.dexignzone.com/"> Epiclance</a> ltd. All Rights Reserved.</p>
                        </div>
