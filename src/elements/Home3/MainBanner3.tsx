							...
							<div className="inner-content">
								<div className="content-info">
									...
									<div className="content-btn m-b30 wow fadeInUp" data-wow-delay="0.8s" data-swiper-parallax="-60">
										...
										<Link  className="btn btn-outline-secondary btn-lg btnhover20" href="/shop">VIEW DETAILS</Link>
									</div>
								</div>
							</div>
							<div className="row">
								<div className="col-sm-12 col-md-6 col-lg-5 mb-3 wow fadeInUp" data-wow-delay="0.1s">
									<div className="product-card">
										...
										<div className="dz-content">
											<h5 className="dz-title"><Link href="/shop">Collar Casual Shirt</Link></h5>
