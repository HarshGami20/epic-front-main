                        ...
                        <CommanSidebar />
                            <section className="col-xl-9 account-wrapper">
                                <div className="account-card">
                                    <div className="m-b30">
                                        <p>Hello <strong className="text-black">{user.firstName} {user.lastName}</strong> (not <strong className="text-black">{user.firstName} {user.lastName}</strong>? <span style={{cursor: 'pointer'}} onClick={() => { localStorage.removeItem('user'); localStorage.removeItem('token'); router.push('/login'); }} className="text-underline text-primary">Log out</span>)</p>
